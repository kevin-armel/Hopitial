...
public class FenRUD_service extends JFrame{
    ...
    private final JButton btnCleDocteur = new JButton("Choix Docteur");
    
    private final JTable tableDonnees = new JTable(17, 5);
    
    private final JLabel labCode = new JLabel("Code (3 Charactès): ");
    private final JLabel labNom = new JLabel("Nom du service: ");
    private final JLabel labBatiment = new JLabel("Batiment du service: ");
    //private final JLabel labCleDoc = new JLabel("Choix du docteur en charge: ");
    
    private final JTextField fieldNom = new JTextField();
    private final JTextField fieldCode = new JTextField();
    private final JTextField fieldCleDoc = new JTextField();
    ...
    public FenRUD_service(){
        ...
        bl.add(checkOnModif, BorderLayout.CENTER);
        ...
        gbcLayout.gridheight = 1;
        pan_1.add(bl, gbcLayout); // je l'ajoute à cette position de départ
        ...
        gbcLayout.gridwidth = 1;
        gbcLayout.gridheight = 1;
        pan_1.add(labBatiment, gbcLayout); // je l'ajoute à cette position de départ
        gbcLayout.gridx = 1;
        gbcLayout.fill = GridBagConstraints.HORIZONTAL;
        gbcLayout.gridwidth = GridBagConstraints.REMAINDER;
        gbcLayout.gridheight = 1;
        pan_1.add(comboBatiment, gbcLayout); // je l'ajoute à cette position de départ
        ...
        gbcLayout.gridwidth = 1;
        gbcLayout.gridheight = 1;
        pan_1.add(btnCleDocteur, gbcLayout); // je l'ajoute à cette position de départ
        gbcLayout.gridx = 1;
        gbcLayout.fill = GridBagConstraints.HORIZONTAL;
        gbcLayout.gridwidth = GridBagConstraints.REMAINDER;
        gbcLayout.gridheight = 1;
        pan_1.add(fieldCleDoc, gbcLayout); // je l'ajoute à cette position de départ
    ...
    public JTextField getFieldCleDoc() {
        return fieldCleDoc;
    }
